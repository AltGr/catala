...
val earray :
  ('a, 't) marked_gexpr Bindlib.box list -> 't -> ('a, 't) marked_gexpr Bindlib.box
...
val eassert :
  (([< dcalc | lcalc ] as 'a), 't) marked_gexpr Bindlib.box -> 't -> ('a, 't) marked_gexpr Bindlib.box
...
val eifthenelse :
  (([< desugared | scopelang | dcalc | lcalc ] as 'a), 't) marked_gexpr Bindlib.box ->
  ('a, 't) marked_gexpr Bindlib.box ->
  ('a, 't) marked_gexpr Bindlib.box ->
  't ->
  ('a, 't) marked_gexpr Bindlib.box
...
val eerroronempty :
  (([< desugared | scopelang | dcalc ] as 'a), 't) marked_gexpr Bindlib.box -> 't -> ('a, 't) marked_gexpr Bindlib.box
...
val map_gexpr_top_down :
  ...
  ('a, 't1) marked_gexpr -> ('a, 't2) marked_gexpr Bindlib.box
