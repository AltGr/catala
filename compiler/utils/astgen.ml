...
(** The generic type of AST markings. Using a GADT allows functions to be
    ...
    appropriate. Expected to fill the ['t] parameter of [gexpr] and [marked_gexpr] *)
type _ mark =
...
(** Constructs scopes and programs on top of expressions. We may use the [gexpr] type above at some point, but at the moment this is polymorphic in the types of the expressions. Their markings are constrained to belong to the [mark] GADT defined above. *)
