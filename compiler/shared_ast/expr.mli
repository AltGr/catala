...
val distribute_negation : Pos.t -> (<monomorphic: yes; polymorphic: yes; ..> as 'a, 'm) gexpr -> ('a, 'm) gexpr
(** from [e], returns [not e] where the [not] has been distributed to conjunctions, disjunctions and boolean literals *)
