...
(** Computes a JSON encoding of a Catala type using [Value.t] as an
...
val parse_json :
  Value.t Json_encoding.encoding -> Yojson.Safe.t -> Value.t
...
val convert_from_gexpr : decl_ctx -> (_, 'm) gexpr -> Value.t
