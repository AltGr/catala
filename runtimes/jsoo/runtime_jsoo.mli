...
val position_of_js :
  code_location Js.t -> Catala_runtime.code_location

val position_to_js :
  Catala_runtime.code_location -> code_location Js.t

val execute_or_throw_error : (unit -> 'a) -> 'a
(** [execute_or_throw_error f] calls [f ()] and propagates the
    {!Catala_runtime.NoValue}, {!Catala_runtime.Conflict} {!Catala_runtime.AssertionFailed}
