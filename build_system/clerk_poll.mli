...
(** Set if, and only if the current build happens from within the Catala compiler source tree itself. This requires some specific options and includes for correct bootstrapping, and running the tests without requiring an installation first. *)
