...
type test = {
  ...
  expected: Lexing.position * Lexing.position; (** The precise offsets of the expected result in the source file *)
  result: Lexing.position * Lexing.position; (** Same for the actual result in the destination file *)
}
...
val display: columns:int -> build_dir:File.t -> Format.formatter -> test -> unit
val summary: columns:int -> build_dir:File.t -> file list -> bool
